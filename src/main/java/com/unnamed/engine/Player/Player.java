...
import com.unnamed.engine.Board.MoveStatus;
import com.unnamed.engine.Board.MoveTransition;
import com.unnamed.engine.Pieces.King;
...
public abstract class Player {
    ...
    public boolean isInStaleMate() {
        return !this.isInCheck && !hasEscapeMoves(); //alternatively will legalMoves.isEmpty() work? TBC during text cases.
    }
