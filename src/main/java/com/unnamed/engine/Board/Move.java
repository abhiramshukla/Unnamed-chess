...
import com.unnamed.engine.Pieces.Pawn;
import com.unnamed.engine.Pieces.Piece;
import com.unnamed.engine.Pieces.Rook;

import static com.unnamed.engine.Board.Board.*;
...
public abstract class Move {
    ...
    public Board execute() {
        ...
        for (final Piece piece : this.board.currentPlayer().getActivePieces()) {
            //TODO hashcode and equal for pieces;
    ...
    public static final class NullMove extends Move {
        ...
        private NullMove() {
            super(null, null, -1); //TODO this is for now
        }
